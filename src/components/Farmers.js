...
function Farmers() {
  const features = [
    ...
    {
      id: 'multi-language-accessibility',
    ...
    {
      id: 'easy-to-understand-contracts',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="h-[80px] bg-[#0D1B2A] flex items-center justify-center">
          <h2 className="text-4xl font-bold text-center bg-[#0D1B2A] text-white">
            Why Farmers Should Choose कृषिNet
          </h2>
        </div>
